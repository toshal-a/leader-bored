...
ACCESS_TOKEN_EXPIRE_MINUTES = config(
    "ACCESS_TOKEN_EXPIRE_MINUTES", cast=int, default=60 * 24 * 8)
...
MAIL_SENDER_EMAIL = config(
    "MAIL_SENDER_EMAIL", default="cp-leaderboard@cp-leaderboard.me")
MAIL_SENDER_PASSWORD = config("MAIL_SENDER_PASSWORD", default="")
PROJECT_NAME = config("PROJECT_NAME", default="leaderboard")
TEMPLATE_DIR = config("TEMPLATE_DIR", default=".")
